...
ROUTING_CASES: list[dict[str, str]] = [
    ...
    {"query": "What are the overtime rates under the enterprise agreement?", "expected_agent": "hr_agent"},
    ...
    {"query": "Can you explain the enterprise agreement clause on shift allowances?", "expected_agent": "hr_agent"},
