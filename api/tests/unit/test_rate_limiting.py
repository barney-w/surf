...
from src.middleware.rate_limit import _get_user_key, limiter


class TestGetUserKey:
    """Tests for the _get_user_key key function."""
...
class TestLimiterObject:
    ...
    def test_limiter_uses_user_key_function(self):
        """The limiter's key_func should be _get_user_key."""
        assert limiter._key_func is _get_user_key
