...
class TestSourceUrlValidation:
    def test_rejects_javascript_scheme(self):
        from src.connectors.pdf import _validate_source_url
    ...
    def test_accepts_http(self):
        from src.connectors.pdf import _validate_source_url
        assert _validate_source_url("http://intranet.local/doc.pdf") == "http://intranet.local/doc.pdf"
...
class TestManifestPathTraversal:
    ...
    def test_manifest_entry_with_missing_required_fields(self):
        ...
        with patch("src.connectors.pdf.extract_text_from_pdf", return_value="content"):
